...
TEST(LZ77Test, PackUnPackTest)
{
    ...
    std::string test_path2 = "../../test/test_data/archiver_test_3.lz7710";

    std::remove("../../test/test_data/archiver_test_1.lz775");
    std::remove("../../test/test_data/archiver_test_1.unlz775");

    arch.pack_file(test_path1, 8 * 1024, 2*1024);
    arch.unpack_file(test_path2, 8 * 1024, 2*1024);

    std::fstream fin1;
    std::fstream fin2;
    fin1.open("../../test/test_data/archiver_test_3.unlz7710", std::ios::in);
