...
TEST(LZ77Test, PackUnPackTest)
{
    ...
    LZ77 arch;
    std::string test_path1 = "../../test/test_data/archiver_test_2";
    std::string test_path2 = "../../test/test_data/archiver_test_2.lz775";

    std::remove("../../test/test_data/archiver_test_2.lz775");
    std::remove("../../test/test_data/archiver_test_2.unlz775");
    ...
    std::fstream fin1;
    std::fstream fin2;
    fin1.open("../../test/test_data/archiver_test_2.unlz775", std::ios::in);
